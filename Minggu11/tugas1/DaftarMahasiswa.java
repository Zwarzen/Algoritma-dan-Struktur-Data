...
public class DaftarMahasiswa {
    ...
    public void TambahFirst(int nim, String nama, String alamat) {
    ...
    public void TambahLast(int nim, String nama, String alamat) {
        if (isEmpty()) {
            TambahFirst(nim, nama, alamat);
        } else {
            Mahasiswa tmp = head;
    ...
    public Object DapatFirst() throws Exception {
        if (isEmpty()) {
    ...
    public Object DapatLast() throws Exception {
        if (isEmpty()) {
            throw new Exception("Linked List KOSONG!");
        }
        Mahasiswa tmp = head;
